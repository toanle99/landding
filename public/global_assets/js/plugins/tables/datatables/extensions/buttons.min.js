...
(function(g) {
    ...
    j.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", "Xuất file Excel")
        },
        action: function(a, b, d, c) {
            this.processing(!0);
            var a = c._flash,
                ...
                k, l, j = function(a) {
                    ...
                    if(e > 1) l.removeChild(l.lastChild);
                    h.appendChild(l);
                    e++
                };
    ...
    j.ext.buttons.pdfFlash =
        g.extend({}, u, {
            ...
            text: function(a) {
                return a.i18n("buttons.pdf", "Xuất file PDF")
            },
            action: function(a, b, d, c) {
                this.processing(!0);
                var a = c._flash,
        ...
        action: function(a, b, d, c) {
            ...
            var f = this,
                ...
                l, m, r = function(a) {
                    ...
                    if(g > 1) m.removeChild(m.lastChild);
                    h.appendChild(m);
                    g++
                };
            ...
            for (var g = 0, e = d.body.length; g < e; g++) 
                f.push(
                    i.map(d.body[g], function(a) {
                        if(d.body[g][d.body[g].length-1].trim() == a.trim()) 
                        return {
                            text: "",
