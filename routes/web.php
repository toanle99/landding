...
Route::group(['namespace' => 'SupportLandding',], function(){
    Route::get('/',                  'LanddingController@index')->name('landding.home');
    Route::post('/landding-store',   'LanddingController@store')->name('landding.store');
    
    Route::post('/landding-store-hoadon',   'LanddingController@storeHoadon')->name('landding.storeHoadon');
    Route::get('/start-event',       'LanddingController@startEvent')->name('landding.startEvent');
    Route::get('/event-step-2',      'LanddingController@eventStep2')->name('landding.eventStep2');
    Route::get('/event-step-3',      'LanddingController@eventStep3')->name('landding.eventStep3');
    
    Route::post('/landding-signature-save',   'LanddingController@signatureSave')->name('signature.save');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'my_account'], function() {
        ...
        Route::post('/', 'MyAccountController@update_profile')->name('my_account.update');
    ...
    Route::group(['prefix' => 'ajax_landding'], function() {
        Route::get('get_thanhpho', 'AjaxLanddingController@get_thanhpho')->name('get.thanhpho'); 
        Route::get('get_quan/{thanhpho_id}', 'AjaxLanddingController@get_quan')->name('get.quan'); 
        Route::get('get_cuahang', 'AjaxLanddingController@get_cuahang')->name('get.cuahang');  
    });
});
