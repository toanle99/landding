...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title',          'description' => 'HỆ THỐNG QUẢN LÝ SỰ KIỆN MEGA'],
            ['type' => 'system_footer',         'description' => 'Phát triển bởi 黎文全'],
            ['type' => 'system_name',           'description' => 'HỆ THỐNG QUẢN LÝ SỰ KIỆN MEGA'],
