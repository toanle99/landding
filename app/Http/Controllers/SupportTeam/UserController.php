...
class UserController extends Controller
{
    ...
    public function update(UserRequest $req, $id)
    {
        ...
        // $message = [
        //     'type' => 'Giấy xin phép',
        //     'task' => 'Xin nghỉ ngày buổi sáng 10/02/2022',
        //     'content' => ' \n lý do: lý do xin nghỉ ',
        // ];
        // $title = 'Giấy xin phép từ: '. 'Lê Văn Toàn';
        // SendEmail::dispatch($message, 'toanle20299@gmail.com', $title)->delay(now());


        $user_type = $this->user->findType(Qs::decodeHash($req->user_type))->title;
        $data['user_type'] = $user_type;
        $id = Qs::decodeHash($id);
        // dd($user_type);
        // Redirect if Making Changes to Head of Super Admins
