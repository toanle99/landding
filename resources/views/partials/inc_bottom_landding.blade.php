...
<script type="text/javascript" src="{{ asset('global_assets/js/plugins/daterangepicker/daterangepicker.min.js')}}"></script>
<link rel="stylesheet" type="text/css" href="{{ asset('global_assets/js/plugins/daterangepicker/daterangepicker.css')}}" />
...
--}}
<script src=" {{ asset('assets/js/landding/script.js') }} "></script>
