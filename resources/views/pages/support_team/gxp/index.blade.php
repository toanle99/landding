...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Con: {{ $student->user->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade {{Qs::userIsTeamSAT()&& $ut->level==1?'show active':(Qs::userIsParent()&&$ut->level==0?'show active':'')}}" id="ut-{{Qs::hash($ut->id)}}" >                         
                    <table class="table datatable-button-html5-columns show">
                        ...
                        <tbody>
                        @foreach($gxps->where('status', $ut->level)->where('student_record_id', $student->id) as $u)
                            <tr>
    ...
    @endforeach
    @endif
    @if(Qs::userIsTeamSAT()||Qs::userIsStudent())
    <div class="card">
        <div class="card-header header-elements-inline">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="dob" id="dob" value="{{ old('dob') }}" type="text" disabled class="form-control date-pick" placeholder="Ngày sinh..." >
                                    </div>
                                </div> 
