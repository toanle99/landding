...
@section('page_title', 'Danh sách học sinh - '.$my_class->name)
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Danh sách học sinh</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item">
                    <a href="#all-students" class="nav-link active" data-toggle="tab">Học sinh lớp {{ $my_class->name }}</a>
                </li>
