                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="gender" name="gender" required data-fouc data-placeholder="Giới tính ..">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Sđt:</label>
                                <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="Sđt ... " >
                            </div>
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="dob" value="{{ old('dob') }}" type="text" class="form-control date-pick" placeholder="Ngày sinh ...">
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" data-placeholder="Lớp ..." required name="my_class_id" id="my_class_id" class="select-search form-control">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Phụ huynh ..."  name="my_parent_id" id="my_parent_id" class="select-search form-control">
                                    <option  value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Năm nhâp học..." required name="year_admitted" id="year_admitted" class="select-search form-control">
                                    <option value=""></option>
