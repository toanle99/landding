                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select required data-placeholder="Loại người dùng" class="form-control select" name="user_type" id="user_type">
                                        @foreach($user_types as $ut)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('username') }}" required type="text" name="username" class="form-control" placeholder="User name">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" name="emp_date" value="{{ old('emp_date') }}" type="text" class="form-control date-pick" placeholder="Ngày làm việc ...">
                                    </div>
                                </div>
